...
const SinglePopularInstructors = ({ instructor }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row  items-center justify-around mx-auto gap-1  md:gap-8 h-full w-full rounded-md shadow-md p-4 transition-transform ease-in-out duration-300 bg-[#8294C4] text-[#f7dab9]">
      ...
      <div className="md:w-1/2 px-1 md:px-4 mt-3 md:mt-0">
        ...
        {classes && (
          <p className="font-semibold">Number of Classes: {classes.length}</p>
        )}
